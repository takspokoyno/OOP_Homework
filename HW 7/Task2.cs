...
//Були порушені принципи Single Responsibility і Open Closed, логування виносимо в окремий клас, а  також щоб не порушити Dependency Inversion створимо інтерфейс. 
//За необхідності іншого логування, потрібно буде просто створити новий імплементатор даного інтерфейсу та використати його.
...
class EmailConsoleLogger : IEmailLogger
{
...
class EmailSender
{
    ...
    public EmailSender(IEmailLogger logger)
    {
        _logger = logger;
    }
...
class Program
{
    static void Main(string[] args)
    {
        ...
        IEmailLogger logger = new EmailConsoleLogger();
